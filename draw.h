...
void offsetSegments(seg_or_flag *src_pre, uint8 x, uint8 y);
void insetSegments(seg_or_flag *src_pre, uint8 x, uint8 y);
...
// utility routine for AMP: update the remote buffer
// void update_amp_buffer(int which_buf);
