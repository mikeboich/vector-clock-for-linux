...
vector_font Exclam ={
{01,13,00,22,legacy_pos,0x99},
{01,01,02,02,cir,0xff},
{.flag=0x82},

};
vector_font DQuot={
{00,16,00,12,legacy_pos,0x99},
{06,16,00,12,legacy_pos,0x99},
{.flag=0x86},

};
vector_font Sharp={
{03,12,03,24,legacy_pos,0x99},
{8,12,03,24,legacy_pos,0x99},
{05,9,15,00,legacy_pos,0x99},
{06,15,15,00,legacy_pos,0x99},
{.flag=0x8c},
...
vector_font Aster={
{06,10,18,00,legacy_pos,0x99},
{06,10,12,18,legacy_pos,0x99},
{06,10,12,18,legacy_neg,0x99},
{.flag=0x8c},

};
vector_font Plus={
{06,10,18,00,legacy_pos,0x99},
{06,10,00,18,legacy_pos,0x99},
{.flag=0x8c},
...
vector_font LThan={
{06,14,18,12,legacy_pos,0x99},
{06,06,18,12,legacy_neg,0x99},
{.flag=0x8c},

};
vector_font Equal={
{06,13,18,00,legacy_pos,0x99},
{06,07,18,00,legacy_pos,0x99},
{.flag=0x8c},

};
vector_font GThan={
{06,14,18,12,legacy_neg,0x99},
{06,06,18,12,legacy_pos,0x99},
{.flag=0x8c},
...
vector_font LftSqBr={
{00,10,00,30,legacy_pos,0x99},
{02,00,06,00,legacy_pos,0x99},
{02,20,06,00,legacy_pos,0x99},
{.flag=0x84},

};
vector_font BackSl={
{06,10,18,30,legacy_neg,0x99},
{.flag=0x8c},

};
vector_font RtSqBr={
{04,10,00,30,legacy_pos,0x99},
{02,00,06,00,legacy_pos,0x99},
{02,20,06,00,legacy_pos,0x99},
{.flag=0x84},
...
vector_font Carat={
{03,13,9,9,legacy_pos,0x99},
{9,13,9,9,legacy_neg,0x99},
{.flag=0x8c},

};
vector_font UnderSc={
{06,00,18,00,legacy_pos,0x99},
{.flag=0x8c},

};
vector_font BackQu={
{02,16,06,12,legacy_neg,0x99},
{.flag=0x84},
...
vector_font Rubout={
{03,15,9,15,legacy_pos,0x99},
{06,10,18,30,legacy_pos,0x99},
{9,05,9,15,legacy_pos,0x99},
{.flag=0x8c},
...
vector_font One={
{07,10,00,30,legacy_pos,0x99},
{05,18,06,06,legacy_pos,0x99},
{.flag=0x8c},
...
{06,20,15,00,legacy_pos,0x99},
{.flag=0x8c},

};
vector_font Four={
{8,10,00,30,legacy_pos,0x99},
{06,06,18,00,legacy_pos,0x99},
{04,13,12,22,legacy_pos,0x99},
{.flag=0x8c},

};
vector_font Five={
{06,06,12,12,cir,0xf9},
{03,15,03,15,legacy_pos,0x99},
{8,20,12,00,legacy_pos,0x99},
{.flag=0x8c},

};
vector_font Six={
{06,06,12,12,cir,0xff},
{05,15,9,15,legacy_pos,0x99},
{.flag=0x8c},

};
vector_font Seven={
{06,10,18,30,legacy_pos,0x99},
{06,20,18,00,legacy_pos,0x99},
{.flag=0x8c},
};
vector_font Eight={
{06,06,12,12,cir,0xff},
...
{07,05,9,15,legacy_pos,0x99},
{.flag=0x8c},

};
vector_font BigA={
{03,10,9,30,legacy_pos,0x99},
{9,10,9,30,legacy_neg,0x99},
{06,8,9,00,legacy_pos,0x99},
{.flag=0x8c},

};
vector_font BigB={
{00,10,00,30,legacy_pos,0x99},
{04,00,12,00,legacy_pos,0x99},
{04,10,12,00,legacy_pos,0x99},
{04,20,12,00,legacy_pos,0x99},
{8,05,10,10,cir,0xf0},
{8,15,10,10,cir,0xf0},
{.flag=0x8c},
...
vector_font BigG={
{07,10,14,20,cir,0x9f},
{11,05,00,9,legacy_pos,0x99},
{9,8,06,00,legacy_pos,0x99},
{.flag=0x8c},

};
vector_font BigH={
{00,10,00,30,legacy_pos,0x99},
{12,10,00,30,legacy_pos,0x99},
{06,10,18,00,legacy_pos,0x99},
{.flag=0x8c},

};
vector_font BigI={
{02,10,00,30,legacy_pos,0x99},
{02,00,9,00,legacy_pos,0x99},
{02,20,9,00,legacy_pos,0x99},
{.flag=0x84},

};
vector_font BigJ={
{12,13,00,22,legacy_pos,0x99},
...
vector_font BigK={
{00,10,00,30,legacy_pos,0x99},
{06,05,18,15,legacy_neg,0x99},
{06,15,18,15,legacy_pos,0x99},
{.flag=0x8c},
...
{00,10,00,30,legacy_pos,0x99},
{12,10,00,30,legacy_pos,0x99},
{03,15,9,15,legacy_neg,0x99},
{9,15,9,15,legacy_pos,0x99},
{.flag=0x8c},
...
vector_font BigT={
{06,10,00,30,legacy_pos,0x99},
{06,20,18,00,legacy_pos,0x99},
{.flag=0x8c},

};
vector_font BigU={
{00,13,00,22,legacy_pos,0x99},
{12,13,00,22,legacy_pos,0x99},
{06,06,12,12,cir,0xc3},
{.flag=0x8c},
...
vector_font BigV={
{03,10,9,30,legacy_neg,0x99},
{9,10,9,30,legacy_pos,0x99},
{.flag=0x8c},
...
vector_font SmallD={
{05,06,10,12,cir,0xff},
{10,10,00,30,legacy_pos,0x99},
{.flag=0x8a},

};
vector_font SmallE={
{05,06,10,12,cir,0xbf},
{05,06,15,00,legacy_pos,0x99},
{.flag=0x8a},
...
{04,8,8,8,cir,0x3c},
{00,10,00,30,legacy_pos,0x99},
{8,04,00,12,legacy_pos,0x99},
{.flag=0x88},

};
vector_font SmallI={
{01,16,02,02,cir,0xff},
{01,06,00,18,legacy_pos,0x99},
{.flag=0x82},

};
vector_font SmallJ={
{06,16,02,02,cir,0xff},
{06,06,00,18,legacy_pos,0x99},
{03,00,06,8,cir,0xc1},
{.flag=0x88},
...
vector_font SmallK={
{00,10,00,30,legacy_pos,0x99},
{04,8,12,12,legacy_pos,0x99},
{04,03,9,9,legacy_neg,0x99},
{.flag=0x88},

};
vector_font SmallL={
{01,10,00,30,legacy_pos,0x99},
{.flag=0x82},

};
vector_font SmallM={
{00,06,00,18,legacy_pos,0x99},
{04,8,8,8,cir,0x3c},
{8,04,00,12,legacy_pos,0x99},
{12,8,8,8,cir,0x3c},
{16,04,00,12,legacy_pos,0x99},
{.flag=0x90},
...
vector_font SmallP={
{05,06,10,12,cir,0xff},
{00,03,00,24,legacy_pos,0x99},
{.flag=0x8a},

};
vector_font SmallQ={
{05,06,10,12,cir,0xff},
{10,03,00,24,legacy_pos,0x99},
{.flag=0x8a},
...
vector_font SmallT={
{8,04,8,8,cir,0x03},
{04,12,12,00,legacy_pos,0x99},
{04,10,00,18,legacy_pos,0x99},
{.flag=0x88},

};
vector_font SmallU={
{8,06,00,18,legacy_pos,0x99},
{04,04,8,8,cir,0xc3},
{00,8,00,12,legacy_pos,0x99},
{.flag=0x88},

};
vector_font SmallV={
{02,06,06,18,legacy_neg,0x99},
{06,06,06,18,legacy_pos,0x99},
{.flag=0x88},
...
{02,06,06,18,legacy_neg,0x99},
{06,06,06,18,legacy_pos,0x99},
{10,06,06,18,legacy_neg,0x99},
{14,06,06,18,legacy_pos,0x99},
{.flag=0x90},

};
vector_font SmallX={
{04,06,12,18,legacy_neg,0x99},
{04,06,12,18,legacy_pos,0x99},
{.flag=0x88},
...
vector_font JDay={
{02,19,06,00,legacy_pos,0x99},
{02,11,06,00,legacy_pos,0x99},
{02,04,06,00,legacy_pos,0x99},
{00,11,00,23,legacy_pos,0x99},
{04,11,00,22,legacy_pos,0x99},
{9,22,9,00,legacy_pos,0x99},
{9,18,9,00,legacy_pos,0x99},
{9,14,9,00,legacy_pos,0x99},
{12,18,00,12,legacy_pos,0x99},
{17,22,9,00,legacy_pos,0x99},
{17,18,9,00,legacy_pos,0x99},
{17,14,9,00,legacy_pos,0x99},
{20,18,00,12,legacy_pos,0x99},
{15,10,17,00,legacy_pos,0x99},
{14,07,17,00,legacy_pos,0x99},
{14,04,17,00,legacy_pos,0x99},
{15,01,20,00,legacy_pos,0x99},
{8,04,00,14,legacy_pos,0x99},
{14,05,00,14,legacy_pos,0x99},
{00,12,19,14,cir,0x40},
{15,11,02,03,legacy_pos,0x81},
{.flag=0x98},
};
vector_font JSun={
{8,19,18,00,legacy_pos,0x99},
{8,10,18,00,legacy_pos,0x99},
{8,18,00,00,legacy_pos,0x99},
{02,10,00,26,legacy_pos,0x99},
{14,10,00,26,legacy_pos,0x99},
{.flag=0x93},
};
vector_font JMon={
{9,20,14,00,legacy_pos,0x99},
{9,13,14,00,legacy_pos,0x99},
{9,06,14,00,legacy_pos,0x99},
{04,13,00,21,legacy_pos,0x99},
{00,06,8,12,cir,0xC0},
{14,10,00,30,legacy_pos,0x99},
{13,00,03,00,legacy_pos,0x81},
{.flag=0x91},
};
vector_font JTue={
{10,15,00,17,legacy_pos,0x99},
{00,10,20,20,cir,0xC0},
{20,10,20,20,cir,0x03},
{00,16,8,15,cir,0x40},
{15,14,03,07,legacy_pos,0x99},
{.flag=0x93},
};
vector_font JWed={
{10,11,00,33,legacy_pos,0x99},
{9,00,03,00,legacy_pos,0x81},
{04,14,07,00,legacy_pos,0x99},
{00,14,14,19,cir,0x40},
{03,05,05,07,legacy_pos,0x99},
{15,13,8,06,legacy_pos,0x99},
{27,19,34,33,cir,0x02},
{17,05,07,07,legacy_neg,0x99},
{.flag=0x94},
};
vector_font JThu={
{10,11,00,34,legacy_pos,0x99},
{10,15,26,00,legacy_pos,0x99},
{01,15,18,22,cir,0x40},
{04,04,10,10,legacy_pos,0x99},
{19,15,18,22,cir,0x02},
{16,04,10,10,legacy_neg,0x99},
{.flag=0x93},
};
vector_font JFri={
{00,22,21,17,cir,0x40},
{04,14,9,06,legacy_pos,0x99},
{21,22,22,17,cir,0x02},
{16,14,8,06,legacy_neg,0x99},
{10,14,12,00,legacy_pos,0x99},
{10,9,25,00,legacy_pos,0x99},
{10,07,00,19,legacy_pos,0x99},
{10,01,26,00,legacy_pos,0x99},
{03,03,8,10,cir,0x20},
{11,06,07,10,cir,0x40},
{.flag=0x94},
};
vector_font JSat={
{10,12,00,31,legacy_pos,0x99},
{10,14,23,00,legacy_pos,0x99},
{10,02,28,00,legacy_pos,0x99},
{.flag=0x95},
};
vector_font JYear={
{00,21,10,12,cir,0x40},
{02,16,04,04,legacy_pos,0x99},
{10,18,18,00,legacy_pos,0x99},
{10,12,16,00,legacy_pos,0x99},
{9,06,26,00,legacy_pos,0x99},
{05,9,00,9,legacy_pos,0x99},
{10,8,00,29,legacy_pos,0x99},
{.flag=0x92},
};
vector_font JTEST={
...
{8,05,10,10,cir,0xf0},
{8,15,10,10,cir,0xf0},
{2,20,0,10,legacy_pos,0xf0},
{8,20,0,10,legacy_pos,0xf0},
{2,0,0,10,legacy_pos,0x0f},
{8,0,0,10,legacy_pos,0x0f},
{.flag=0x8c},
};
...
vector_font TestBox={
{0,0, 255,0,legacy_pos,0x99},
{0,0, 0,255 ,legacy_pos,0x99},
{.flag=0x84},
...
void init_font(){
    ...
    system_font[106] = (seg_or_flag*)&BtcB;
    system_font[107] = (seg_or_flag*)&Deg;
}
